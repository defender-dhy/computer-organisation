...
#endif
static const char *ng0 = "C:/Users/86178/Desktop/Study/CO/p5/ALU.v";
...
LAB20:    t398 = (t0 + 3248);
    ...
    t402 = *((char **)t401);
    memcpy(t402, t3, 8);
    xsi_driver_vfirst_trans(t398, 0, 31);
    t403 = (t0 + 3168);
    *((int *)t403) = 1;
...
LAB72:    t218 = (t0 + 1048U);
    ...
    t220 = *((char **)t218);
    memset(t221, 0, 8);
    xsi_vlog_unsigned_add(t221, 32, t219, 32, t220, 32);
    goto LAB73;
...
LAB94:    if (*((unsigned int *)t227) > 0)
        goto LAB95;

LAB96:    memcpy(t226, t264, 8);

LAB97:    goto LAB75;

LAB76:    xsi_vlog_unsigned_bit_combine(t187, 32, t221, 32, t226, 32);
    goto LAB80;
...
LAB89:    t256 = (t0 + 1048U);
    ...
    t258 = *((char **)t256);
    memset(t259, 0, 8);
    xsi_vlog_unsigned_minus(t259, 32, t257, 32, t258, 32);
    goto LAB90;
...
LAB93:    xsi_vlog_unsigned_bit_combine(t226, 32, t259, 32, t264, 32);
    goto LAB97;

LAB95:    memcpy(t226, t259, 8);
    goto LAB97;
...
LAB138:    if (*((unsigned int *)t340) != 0)
        goto LAB139;

LAB140:    t347 = (t333 + 4);
    t348 = *((unsigned int *)t333);
    t349 = *((unsigned int *)t347);
    t350 = (t348 || t349);
    if (t350 > 0)
        goto LAB141;

LAB142:    t352 = *((unsigned int *)t333);
    t353 = (~(t352));
...
LAB146:    if (*((unsigned int *)t333) > 0)
        goto LAB147;

LAB148:    memcpy(t332, t356, 8);

LAB149:    goto LAB124;

LAB125:    t363 = (t0 + 1528U);
    t364 = *((char **)t363);
    t363 = ((char*)((ng10)));
    memset(t365, 0, 8);
    t366 = (t364 + 4);
...
LAB151:    *((unsigned int *)t365) = 1;

LAB153:    memset(t362, 0, 8);
    t381 = (t365 + 4);
...
LAB161:    if (*((unsigned int *)t388) > 0)
        goto LAB162;

LAB163:    if (*((unsigned int *)t362) > 0)
        goto LAB164;

LAB165:    memcpy(t361, t392, 8);

LAB166:    goto LAB126;

LAB127:    xsi_vlog_unsigned_bit_combine(t302, 32, t332, 32, t361, 32);
    goto LAB131;

LAB129:    memcpy(t302, t332, 8);
    goto LAB131;
...
LAB141:    t351 = ((char*)((ng8)));
    goto LAB142;

LAB143:    t356 = ((char*)((ng9)));
    goto LAB144;

LAB145:    xsi_vlog_unsigned_bit_combine(t332, 32, t351, 32, t356, 32);
    goto LAB149;

LAB147:    memcpy(t332, t351, 8);
    goto LAB149;
...
LAB158:    t392 = (t0 + 1208U);
    t393 = *((char **)t392);
    goto LAB159;

LAB160:    t392 = ((char*)((ng9)));
    goto LAB161;

LAB162:    xsi_vlog_unsigned_bit_combine(t361, 32, t393, 32, t392, 32);
    goto LAB166;

LAB164:    memcpy(t361, t393, 8);
    goto LAB166;
