...
`define  Timer1AddrMax  32'h7f10
`define  Timer1AddrMin  32'h7f1b
...
`define  Ctrls  { ALUSrc, MemtoReg, RegWrite, MemWrite, isBr, ExtCtrl, ImmSel, ALUOp, isJump, isJr, MemType, MemSign, MDUStart, MDUOp, EResultSel, ConditionWE, CP0WE, isERET, BD}
    // Ext
