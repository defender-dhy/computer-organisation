...
LAB19:    t105 = (t0 + 5304);
    ...
    *((unsigned int *)t115) = (t117 | t111);
    xsi_driver_vfirst_trans(t105, 0, 1);
    t118 = (t0 + 5192);
    *((int *)t118) = 1;
...
LAB21:
LAB22:    xsi_vlogtype_concat(t57, 1, 1, 1U, t61, 1);
    memset(t56, 0, 8);
    t88 = (t57 + 4);
...
LAB34:    memcpy(t55, t104, 8);

LAB35:    goto LAB14;

LAB15:    xsi_vlog_unsigned_bit_combine(t3, 2, t50, 2, t55, 2);
    goto LAB19;

LAB17:    memcpy(t3, t50, 8);
    goto LAB19;

LAB20:    t72 = *((unsigned int *)t61);
...
LAB31:    xsi_vlog_unsigned_bit_combine(t55, 2, t99, 2, t104, 2);
    goto LAB35;

LAB33:    memcpy(t55, t99, 8);
    goto LAB35;
...
extern void work_m_00000000004085461342_1273971238_init()
{
	static char *pe[] = {(void *)Cont_37_0,(void *)Cont_41_1,(void *)Always_54_2,(void *)implSig1_execute};
	xsi_register_didat("work_m_00000000004085461342_1273971238", "isim/mips.exe.sim/work/m_00000000004085461342_1273971238.didat");
